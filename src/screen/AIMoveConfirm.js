    ...
    const auctionViewApi = async () => {
        ...
        await ApiExpert.send('auction_view', {'idx':params.idx}, (args)=>{
            ...
            if(resultItem.result === 'Y' && arrItems) {
              // console.log('역경매 상세 보기: ', resultItem, arrItems);a
        ...
        <Box flex={1} backgroundColor='#fff'>
            ...
            <ScrollView>
                ...
                <Box borderTopWidth={8} borderTopColor='#F3F4F5' px='25px' py='20px'>
                    ...
                    {/* {
                        auctionChecked == "Y" ?
                        <DefButton text='경매참여완료' btnStyle={[styles.submitBtn, {marginTop:20, backgroundColor:'#999'}]} textStyle={[{color:'#fff'}, fweight.m]} disabled={true}  />
                        :

...
const SmallMoveDate = (props) => {
    ...
    const nextNavigation = () => {
        //console.log('ㄱㄱ');
        navigation.navigate("SmallMoveHelp", {"item":params.item, "moveCategory":params.moveCategory, "pakageType":params.pakageType, "personStatus":params.personStatus, "keepStatus":params.keepStatus, "startMoveTool":params.startMoveTool, "startFloor":params.startFloor, "startAddress": params.startAddress, "destinationMoveTool":params.destinationMoveTool, "destinationFloor":params.destinationFloor, "destinationAddress":params.destinationAddress, "moveDate":sdates, "moveDatetime":moveTime });
    }
            ...
            <ScrollView>
                <Box px='25px' py='20px'>
                    <HStack alignItems={'center'} justifyContent='flex-end'>
                        <Box width='13px' height='13px' borderRadius={13} style={[colorSelect.sky]}  />

...
const TwoRoomDestinationTool = (props) => {
    ...
    const nextNavigation = () => {
        // console.log('ㄱㄱ');
        navigation.navigate("TwoRoomDate", {
            ...
            "destinationMoveTool":destinationMoveTool,
            "destinationFloor":floorInfo,
            "destinationFloorStatus":floorStatus,
...
export default TwoRoomDestinationTool;
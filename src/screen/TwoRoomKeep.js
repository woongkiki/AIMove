...
const TwoRoomKeep = (props) => {
    ...
    const nextNavigation = () => {
        ...
        console.log("다음");
        navigation.navigate("TwoRoomStartAddr", {
                ...
                <Box px='25px' py='20px'>
                    ...
                    <VStack>
                        ...
                        />
                        {
                            ...
                            <VStack>
                                <Box mt='20px'>
                                    <DefText text={"지금 계신 곳의 이사날짜를 선택해 주세요."} style={[styles.labelText]} />

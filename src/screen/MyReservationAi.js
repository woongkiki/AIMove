...
const MyReservationAi = (props) => {
    ...
    return (
        <Box flex={1} backgroundColor='#fff'>
            <SubHeader navigation={navigation} headerTitle='소형이사 예약확인' />
            <ScrollView>
                <Box>
                    {
                        aiImageLoading ?
                ...
                <Box borderTopWidth={8} borderTopColor='#F3F4F5' px='25px' pt='27px' py='20px'>
                    ...
                    <Box style={[styles.confirmBox]}>
                        <Box>
                            <Box style={[styles.confirmBoxCircle]} />
                            <DefText text='결제금액' style={[styles.confirmBoxTitle, {marginTop:-2}]} />
                        </Box>
                        <HStack justifyContent={'space-between'} alignItems='center'>
                            <DefText text={ numberFormat(params.sumsum) + "원 (세금포함)"} style={[styles.confirmBoxText]}/>
                            <HStack justifyContent={'space-between'} alignItems='center'>
                                <TouchableOpacity style={[{marginTop:10, borderBottomWidth:1, borderBottomColor:'#0195ff'}]} onPress={()=>navigation.navigate("PayView", {"bidx":params.bidx, "auction_status":"", "price":params.sumsum, "ex_id":params.ex_id})}>
                                    <DefText text={"결제 확인"} style={[fsize.fs14, {color:'#0195ff'}]} />
                                </TouchableOpacity>
                            </HStack>
                        </HStack>
                    </Box>

...
const TwoauctionImageEnd = (props) => {
    ...
    const twoAuctionEndListApi = async () => {
        ...
        await Api.send('tworoom_endList', {'mid':userInfo.id}, (args)=>{
    ...
    const reviewWrite = (moveDate, today) => {
                                        ...
                                        <Box pt='10px'>
                                            <HStack justifyContent={'space-between'}>
                                                ...
                                                <DefButton 
                                                    ...
                                                    onPress={()=>reviewWrite(item.moveDates, item.today)}
                                                />
                                            </HStack>
                                            {
